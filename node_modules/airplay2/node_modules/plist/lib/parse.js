...
function parse (xml) {
  ...
  if (doc && doc.documentElement && doc.documentElement.nodeName !== 'plist') {
    throw new Error('malformed document. First element should be <plist>');
  }
  var plist = parsePlistXML(doc ? doc.documentElement : null);

  // the root <plist> node gets interpreted as an Array,
  // so pull out the inner data first
  if (plist && plist.length == 1) plist = plist[0];
